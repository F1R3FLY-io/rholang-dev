---
layout: page
title: Rho Lambda Conway
description: Conway's Game of Life in Rho Lambda
---
...
```rholang
[[G]]( l, r ) = productL in GL l!( [[L]]( l, r ) ) | productR in GR r!( [[R]]( l, r ) )

where

products in S P( s ) = P( s ) | P( s' ) | P( s'' ) | ... , for each s in S
